...
namespace EvolveCentral.Administration
{
    public partial class ClientList : System.Web.UI.Page
    {
        ...
        //bool isAuth()
        //{
        //    if (Session[Helper.Constant.CODE_SESSION_ADMINISTRATORNAME] == null || String.IsNullOrEmpty(Session[Common.Constant.CODE_SESSION_ADMINISTRATORNAME].ToString()))
        //        return false;
        ...
        {
            rgvData.DataSource = DAL.Company.GetAll(ctx);
        }
        ...
        protected void rgvData_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Edit":
                    ...
                    Page.Response.Redirect("ClientEdit.aspx?Id=" + id + "&returnurl=" + Page.Request.Url, true);
                    break;

                case "InitInsert":

                    Page.Response.Redirect("ClientEdit.aspx?returnurl=" + Page.Request.Url, true);
                    break;
                case "Delete":
                    ...
                    id = ((GridDataItem)e.Item)["Id"].Text;
                    //DAL.Company.Delete(ctx,Convert.ToInt32(id));
