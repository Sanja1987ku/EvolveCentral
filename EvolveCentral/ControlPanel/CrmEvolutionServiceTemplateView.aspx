<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="CrmEvolutionServiceTemplateView.aspx.cs" Inherits="EvolveCentral.ControlPanel.CrmEvolutionServiceTemplateView" %>
    ...
    <div class="Content">
            ...
            <table>
              <tr>
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" ID="Label4" Text="Service Type:" />
                    </td>
                    <td>
