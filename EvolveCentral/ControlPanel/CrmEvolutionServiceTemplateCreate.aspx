<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="CrmEvolutionServiceTemplateCreate.aspx.cs" Inherits="EvolveCentral.ControlPanel.CrmEvolutionServiceTemplateCreate" %>
       ...
       <telerik:RadAjaxPanel runat="server" ID="rap" LoadingPanelID="ralp">
         <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" ID="Label3" Text="Service Type:" />
                    </td>
                    <td>
                        <asp:Label runat="server" ID="txtServiceType" />
                    </td>
