    <%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="CrmEvolutionServiceDetail.aspx.cs" Inherits="EvolveCentral.ControlPanel.CrmEvolutionServiceDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete(btn) {
           ...
           radconfirm("Do you really want to delete this item?", CallbackFn, 370, 140, null, "DELETE SERVICE DETAIL", "../Images/MessageBox_Question_32x32.png");
        }
    </script>
 ...
 <asp:ImageButton runat="server" ID="imgDelete"    ImageUrl="~/Images/Grid_Delete_16x16.png" />
    ...
    <table style="width:100%;">
        ...
        <asp:EntityDataSource runat="server" ID="eds"  ConnectionString="name=entitiesEvolveCentral"  DefaultContainerName="entitiesEvolveCentral" EnableFlattening="False" EntitySetName="ServiceCrmEvolutionDetailItems" OnSelecting="eds_Selecting" AutoGenerateWhereClause="false" />
