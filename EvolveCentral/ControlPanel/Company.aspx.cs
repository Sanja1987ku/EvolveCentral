...
namespace EvolveCentral.ControlPanel
{
    public partial class Company : System.Web.UI.Page
    {
        ...
        string RequiredPermission_Create = "UserManagement_Company_Create";
        string RequiredPermission_Edit = "UserManagement_Company_Edit";
        string RequiredPermission_Delete = "UserManagement_Company_Delete";
        ...
        protected void rgvData_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            {
                case "InitInsert":
                    Response.Redirect("CompanyCreate.aspx", true);
                    break;
                case "View":
                    id = ((e.Item as GridDataItem)).GetDataKeyValue("Id").ToString();
                    Response.Redirect("CompanyView.aspx?Id=" + id, true);
                    break;
                case "Edit":
                    id = ((e.Item as GridDataItem)).GetDataKeyValue("Id").ToString();
                    Response.Redirect("CompanyEdit.aspx?Id=" + id, true);
                    break;
                  }
        } 
