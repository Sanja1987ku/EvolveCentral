<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/Administration.Master" AutoEventWireup="true" CodeBehind="ClientEdit.aspx.cs" Inherits="EvolveCentral.Administration.ClientEdit" %>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <table>                       
                        ...
                        <tr>
                                        <td>
                                            <asp:Label runat="server" ID="Label4" Text="CONTACT:" Font-Bold="true" Font-Size="12px" />
                                        </td>
                                        <td>
                                            <telerik:RadTextBox ID="txtContact" runat="server" />
