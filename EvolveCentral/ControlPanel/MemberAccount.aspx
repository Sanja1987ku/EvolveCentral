    <%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="MemberAccount.aspx.cs" Inherits="EvolveCentral.ControlPanel.MemberAccount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete(btn) {
           ...
           radconfirm("Do you really want to delete this item?", CallbackFn, 370, 140, null, "DELETE MEMBER ACCOUNT", "../Images/MessageBox_Question_32x32.png");
        }
    </script>
            ...
            <telerik:RadGrid ID="rgvData" runat="server" DataSourceId="eds" AutoGenerateColumns="false" AllowPaging="true" AllowFiltering="true"
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-AddNewRecordText="Add new record" CommandItemSettings-RefreshText="Refresh"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="Company" HeaderText="COMPANY" DataField="CompanyItem.Name" />
 ...
 <asp:ImageButton runat="server" ID="imgDelete"    ImageUrl="~/Images/Grid_Delete_16x16.png" />
        ...
        <asp:EntityDataSource runat="server" ID="eds"  ConnectionString="name=entitiesEvolveCentral"  DefaultContainerName="entitiesEvolveCentral" EnableFlattening="False" EntitySetName="MemberAccountItems" OnSelecting="eds_Selecting" AutoGenerateWhereClause="false" Include="CompanyItem" />
