<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="CrmEvolutionServiceDetailView.aspx.cs" Inherits="EvolveCentral.ControlPanel.CrmEvolutionServiceDetailView" %>
            ...
            <table>
              <tr>
               ...
               <tr>
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" ID="Label10" Text="Last modified by administrator:" />
                    </td>
                    <td>
                 ...
                 <tr>
                    <td>
                        <asp:Label runat="server" ID="Label13" Text="Last modified by member:" />
                    </td>
                    <td>
                        <asp:Label runat="server" ID="txtLastModifiedMemberAccount" />
                    </td>
                    <td></td>
                </tr>
               <tr>
                 ...
                 <tr>
                    <td>
                        <asp:Label runat="server" ID="Label14" Text="Unique:" />
                    </td>
                    <td>
                        <asp:Label runat="server" ID="txtUnique" Checked="true" />
                    </td>
                    <td></td>
                </tr>
                 <tr>
