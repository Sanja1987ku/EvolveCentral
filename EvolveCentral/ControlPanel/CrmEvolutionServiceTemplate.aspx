    <%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="CrmEvolutionServiceTemplate.aspx.cs" Inherits="EvolveCentral.ControlPanel.CrmEvolutionServiceTemplate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete(btn) {
           ...
           radconfirm("Do you really want to delete this item?", CallbackFn, 370, 140, null, "DELETE SERVICE TEMPLATE", "../Images/MessageBox_Question_32x32.png");
        }
    </script>
    ...
    <div class="ContentTitle">
        <table>
            <tr>
                ...
                <td>
                  Service Templates - CRM & Evolution
                </td>
            </tr>
        </table>
        <hr />
 ...
 <asp:ImageButton runat="server" ID="imgDelete"    ImageUrl="~/Images/Grid_Delete_16x16.png" />
        ...
        <asp:EntityDataSource runat="server" ID="eds"  ConnectionString="name=entitiesEvolveCentral"  DefaultContainerName="entitiesEvolveCentral" EnableFlattening="False" EntitySetName="ServiceTemplateCrmEvolutionItems" OnSelecting="eds_Selecting" AutoGenerateWhereClause="false" Include="ServiceTypeItem" />
