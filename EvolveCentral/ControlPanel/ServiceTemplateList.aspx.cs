...
{
    public partial class ServiceTemplateList : System.Web.UI.Page
    {
        ...
        {
            rgvData.DataSource = DAL.ServiceTemplateCrmEvolution.GetAll(ctx);
        }
        ...
        protected void rgvData_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Edit":
                    ...
                    Page.Response.Redirect("ServiceTemplateEdit.aspx?Id=" + id + "&returnurl=" + Page.Request.Url, true);
                    break;

                case "InitInsert":

                    Page.Response.Redirect("ServiceTemplateEdit.aspx?returnurl=" + Page.Request.Url, true);
                    break;
                case "Delete":
                    ...
                    id = ((GridDataItem)e.Item)["Id"].Text;
                    //DAL.ServiceTemplateCrmEvolution.Delete(ctx, Convert.ToInt32(id));
                ...
                case "Details":
                    ...
                    id = ((GridDataItem)e.Item)["Id"].Text;
                    Page.Response.Redirect("ServiceTemplateDetailList.aspx?id=" + id + "&returnurl=" + Page.Request.Url, true);
                    break;
                default:
