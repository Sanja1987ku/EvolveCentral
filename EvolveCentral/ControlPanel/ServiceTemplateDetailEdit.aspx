<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/Administration.Master" AutoEventWireup="true" validateRequest="false" CodeBehind="ServiceTemplateDetailEdit.aspx.cs" Inherits="EvolveCentral.Administration.ServiceTemplateDetailEdit" %>
        ...
        <table style="width:100%;">
            <tr>
                <td colspan="2">
                    ...
                    <asp:Panel runat="server" ID="pnl" GroupingText="CREATE/EDIT SERVCE TEMPLATE DETAIL" Width="100%" >
                    <table>                       
                                    <tr>
                                        <td>
                         ...
                         <tr>
                                        <td>
                                            <asp:Label runat="server" ID="Label9" Text="CODE:" Font-Bold="true" Font-Size="12px" />
                                        </td>
                                        <td>
