<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/ControlPanel.Master" AutoEventWireup="true" CodeBehind="AdministratorPermission.aspx.cs" Inherits="EvolveCentral.ControlPanel.AdministratorPermission" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete(btn) {
            ...
            radconfirm("Do you really want to delete this item?", CallbackFn, 370, 140, null, "DELETE PERMISSION", "../Images/MessageBox_Question_32x32.png");
        }
    </script>
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-AddNewRecordText="Add new record" CommandItemSettings-RefreshText="Refresh"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="Id" HeaderText="ID" DataField="Id" HeaderStyle-Width="20px" />
                          <telerik:GridBoundColumn UniqueName="ParentId" HeaderText="PARENT ID" DataField="ParentId" HeaderStyle-Width="20px" />
                        ...
                        <telerik:GridCheckBoxColumn  UniqueName="IsSelectable" HeaderText="IS SELECTABLE" DataField="IsSelectable" />
 ...
 <asp:ImageButton runat="server" ID="imgDelete"    ImageUrl="~/Images/Grid_Delete_16x16.png" />
        ...
        <asp:EntityDataSource runat="server" ID="eds"  ConnectionString="name=entitiesEvolveCentral"  DefaultContainerName="entitiesEvolveCentral" EnableFlattening="False" EntitySetName="AdministratorPermissionItems" OnSelecting="eds_Selecting" AutoGenerateWhereClause="false" />
